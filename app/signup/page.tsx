...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-surface-950 flex items-center justify-center relative overflow-hidden">
            {/* Ambient */}
            <div className="absolute top-[-30%] right-[-20%] w-[500px] h-[500px] rounded-full bg-brand-600/8 blur-[120px]" />
            <div className="absolute bottom-[-30%] left-[-20%] w-[400px] h-[400px] rounded-full bg-accent-500/6 blur-[120px]" />
            ...
            >
                ...
                <div className="glass rounded-2xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-surface-400">Start automating your Instagram DMs in minutes</p>
                    </div>
